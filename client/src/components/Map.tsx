...
// Module-level singleton: ensures the Maps script is injected only once per page load,
// no matter how many MapView instances mount or remount.
...
function loadMapScript(): Promise<void> {
  ...
  if (existingScript) {
    _mapsLoadPromise = new Promise<void>((resolve) => {
      ...
      // If it already fired, google.maps should be available
